...
function drawCards(array){
    ...
    array.forEach( objProduct => {
        container.innerHTML +=`
        <div class="mt-6 flex max-w-md overflow-hidden bg-white rounded-lg shadow-lg">
            <div class="w-1/3 bg-cover bg-landscape">
                    <img src=${objProduct.image} />
            </div>
            <div class="w-2/3 p-4">
                <h1 class="text-xl font-bold text-gray-90 line-clamp-1">
                    ${objProduct.title}
                </h1>
                <p class="mt-2 text-sm text-gray-600 line-clamp-3">
                    ${objProduct.description}
                </p>
                <span class="text-sm bg-green-600 text-white font-bold px-2">${objProduct.category}</span>
